...
const culture = [
  [
    "Engineering",
    "Design reviews, simulation, fabrication, testing, and documentation create engineers who understand complete systems.",
    "/images/TSI-15.png",
    Wrench,
  ],
  [
    "Leadership",
    "Members own deadlines, coordinate people, defend decisions, and learn to operate under real constraints.",
    "/images/TSI-13.png",
    Users,
  ],
  [
    "Innovation",
    "The team uses every season to improve packaging, reliability, manufacturability, and vehicle performance.",
    "/images/TSE-22.png",
    Lightbulb,
  ],
  [
    "Industry Exposure",
    "Sponsors, suppliers, alumni, and competitions connect students to professional engineering expectations.",
    "/images/TSI-25.png",
    Network,
  ],
] as const;
          ...
          <Reveal>
            <div className="mb-10 max-w-3xl">
              ...
              <h2 className="font-display text-[clamp(1.75rem,3.4vw,3.4rem)] font-bold leading-[1.08]">
                Subsystems operating like a race program.
              </h2>
            </div>
          </Reveal>
              ...
              return (
                <Reveal key={slug} delay={(index % 4) * 0.05}>
                  <Link
                    ...
                    className="group block h-full rounded-[8px] border border-white/10 bg-white/[0.05] p-6 backdrop-blur transition hover:-translate-y-1 hover:border-[#ff5400]/60 hover:bg-white/[0.075]"
                  >
        ...
        <div className="container">
          <Reveal>
            <div className="mb-12 max-w-3xl">
              ...
              <h2 className="font-display text-[clamp(1.9rem,3.8vw,3.8rem)] font-bold leading-[1.06]">
          ...
          <div className="grid gap-10">
            {culture.map(([title, copy, image, Icon], index) => (
              <Reveal key={title}>
                <article
                  className={`grid gap-6 lg:grid-cols-2 lg:items-center ${index % 2 ? "lg:[&>div:first-child]:order-2" : ""}`}
                >
                  <div className="relative min-h-80 overflow-hidden rounded-[8px] border border-white/10">
                    <Image
                      src={image}
                      alt={`${title} at Team Srijan`}
                      fill
